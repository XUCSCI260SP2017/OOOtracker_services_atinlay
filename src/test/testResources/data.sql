INSERT INTO users(id,username,password,first_name,last_name,enabled, manager_id) VALUES (0,'staudigelc@xavier.edu','password','Chris','Staudigel',true, 'ellisa4@xavier.edu');
...
INSERT INTO users(id,username,password,first_name,last_name,enabled, manager_id) VALUES (2,'mcnameel@xavier.edu','password','Luke','McNamee',true, 'ellisa4@xavier.edu');

INSERT INTO authorities (username, authority) VALUES ('staudigelc@xavier.edu', 'ROLE_WORKER');
INSERT INTO authorities (username, authority) VALUES ('ellisa4@xavier.edu', 'ROLE_MANAGER');
INSERT INTO authorities (username, authority) VALUES ('mcnameel@xavier.edu', 'ROLE_HR');
